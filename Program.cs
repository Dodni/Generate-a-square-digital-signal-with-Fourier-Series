...
namespace ConsoleApp3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //segedvaltozo a j tombhöz
            double seged = 0;
            //Meg 1től a komponensek számáig

            for (int i = 1; i < buffer.Length; i++)
            {
                //időlépésnek ez a szinusz fogja jelenteni 
                for (int j = 0; j < i; j++)
                {
            ...
            using (StreamWriter writetext = new StreamWriter("write10.csv"))
            {
